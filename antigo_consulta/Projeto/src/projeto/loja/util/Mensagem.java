...
public interface Mensagem {
	...
	// se der errado muda essa coisa aq 
	
	final static String ADD_TECLADO = "\n===Um Teclado sera adicionado===\n";
	final static String ADD_HEADSET = "\n===Um Headset será adicionado===\n";
	final static String ADD_MOUSE	= "\n===Um mouse será adicionado===\n";
	final static String CADASTRO_CLIENTES = "===Cadastrar Clientes===\n";
